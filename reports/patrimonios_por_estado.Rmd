...
A visualização a seguir mostra os 3 candidatos mais ricos por estado
...
candidatos_2018 %>% 
    ...
    plot_ly(mode = 'markers', x = ~sigla_UF, y = ~total_bens, type = 'scatter', 
            marker = list(color = paleta[2]),
            text = ~paste(nome_Urna_Candidato, "(", sigla_UF, ")",
                          "<br>", desc_Cargo, " - ", sigla_Partido,
                          "<br> Em 2018: ", str_to_brl(total_bens)),
            hoverinfo = 'text') %>% 
    layout(xaxis = list(title = "Unidade Federativa"),
           yaxis = list(title = "Valor em Reais"),
           title = "3 maiores patrimônios por estado",
